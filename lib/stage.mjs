...
export const STAGE_RULES = [
  ...
  {
    id: "plan-early", re: /기획완료|입안|열람|사전검토|사전자문|수립범위|정비계획수립|촉진계획|추진계획|지구지정|지구변경|지구계획|설계공모|도시계획\s*심의|위원회\s*심의|공동위/, group: "계획",
    desc: "지정 전 절차(기획완료·입안·열람공고·사전검토·도시계획위원회 심의·지구지정 등, 서울플랜+)",
  },
  ...
  { id: "planning", re: /정비계획|구역지정|정비구역|안전진단|예정|후보|선정|기획/, group: "계획", desc: "정비계획·구역지정·안전진단·예정·후보·선정" },
];
