  ...
  return (
    <main className="mx-auto flex h-full max-w-sm flex-col justify-center overflow-auto px-6">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-gray-500">부서 공용 코드를 입력하면 이 기기에서 180일간 다시 묻지 않습니다.</p>
        <form action={login} className="mt-4 space-y-3">
          ...
          <input
            ...
            placeholder="접속 코드"
            className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-base outline-none focus:border-brand"
          />
          {error && <p className="text-sm text-red-600">코드가 맞지 않습니다.</p>}
